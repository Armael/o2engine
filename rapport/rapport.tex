...
Lorsqu'il s'agit de stocker des données dans une structure de donnée
permettant d'avoir toutes les données pour la restitution du monde. Il
est aussi nécessaire d'avoir des fonctions associé à cette structure
de donnée permettant une certaine interaction avec les éléments de ce
monde, par exemple ajouter ou retirer un élément, actualiser l'élément
...
list tout simplement on a un type Vector * Vector * list.
