...
let openWindow () =
  Graphics.open_graph " 400x60";
  let boutons1 = doButton (5, 5) [|"Simulation avec poids";"Stress-test : 2000 balles (simulation de gaz parfait)";"Pas de poids, nombre moyen de balles"|] 0 false (fun () -> ()) in
